...
if st.button("Baixar e Enviar para o Dropbox"):
    if video_url:
        ...
        if "youtube.com" not in video_url and "youtu.be" not in video_url:
            st.error("Link inválido. Por favor, insira um link do YouTube.")
        else:
            st.info("Baixando o vídeo...")
            local_file = backend.download_video(video_url, "meus_videos")
            ...
            if local_file:
                ...
                st.error("Erro ao baixar o vídeo. Verifique o link ou tente outro vídeo.")  # Mensagem mais amigável
    else:
